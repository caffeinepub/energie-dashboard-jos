...
export interface backendInterface {
    ...
    calculateCosts(defaultGasPricePerM3: number, defaultElectricityPricePerKwh: number, year: number): Promise<Costs>;
    ...
    setYearlyPrices(year: bigint, gasPrice: number, elecPrice: number): Promise<void>;
